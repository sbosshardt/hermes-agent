...
CREATE TABLE IF NOT EXISTS sessions (
    ...
    auto_recall_attempt_count INTEGER DEFAULT 0,
    auto_recall_success_count INTEGER DEFAULT 0,
    auto_recall_failure_count INTEGER DEFAULT 0,
    auto_recall_total_latency_ms INTEGER DEFAULT 0,
    auto_recall_min_latency_ms INTEGER,
    auto_recall_max_latency_ms INTEGER DEFAULT 0,
    handoff_state TEXT,
